...
-- Create hr_users table (without department column initially)
...
-- Insert sample HR users for demo purposes (only after department column exists)
INSERT INTO hr_users (name, email, role, department) VALUES
  ('Sarah Johnson', 'sarah.johnson@company.com', 'hr_manager', 'Human Resources'),
  ('Michael Chen', 'michael.chen@company.com', 'hr_manager', 'Human Resources'),
  ('Emily Rodriguez', 'emily.rodriguez@company.com', 'hr_manager', 'Employee Relations')
