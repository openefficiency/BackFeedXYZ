/*
  # Fix HR Users Data Migration

  This migration adds comprehensive sample data to all tables while fixing the department column issue.
  
  1. Sample Data
    - HR users (without department column)
    - Test cases with realistic scenarios
    - Transcripts with detailed feedback
    - HR interactions showing communication flow
    - AI insights with comprehensive analysis
  
  2. Data Verification
    - Ensures all tables exist before inserting data
...
-- Insert HR Users first (needed for foreign key references) - WITHOUT department column
INSERT INTO hr_users (name, email, role) VALUES
  ...
  ('David Kim', 'david.kim@company.com', 'hr_manager'),
  ('Lisa Wang', 'lisa.wang@company.com', 'hr_specialist');
